		...
		<div class="row">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					mysqli_query($koneksi,"INSERT INTO `jurusan` (`id`, `nama`) VALUES (NULL, '$jurusan')") or die(mysqli_error($koneksi));
					?>

					<script>alert("Data berhasil ditambahkan.");window.location.href="jurusan.php";</script>
