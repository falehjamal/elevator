          ...
          <div class="container">
            <div class="col-lg-4">
              <form method="post" class="form-horizontal">
                ...
                <div class="form-group">
                  <label>alamat</label>
                  <textarea name="alamat1" class="form-control"></textarea>
                  </div>
                  <div class="form-group">
                    <label>profil</label>
                  ...
                  <div class="form-group">
                    ...
                    <a href="sekolah.php"><button type="button" class="btn btn-info">Batal</button></a>
                  </div>
                </form>
              </div>
            </div></div>
            ...
            mysqli_query($koneksi,"INSERT INTO `sekolah` (`id`, `nama`, `alamat`, `profil`, `user_id`) VALUES (NULL, '$nama', '$alamat1', '$profile', '$user_login')");
            ?><script>alert("Data berhasil ditambahkan.");window.location.href="sekolah.php";</script><?php
            }
            }
            ?>
            <?php
