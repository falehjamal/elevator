            ...
            <div class="col-lg-4">
              <form method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="file" accept="application/pdf,image/*" name="files" class="form-control" value="<?php echo $dataa['file']; ?>">
                </div>
                <div class="form-group">
                  <label>Tanggal</label>
          ...
          if ($edit) {
              if(isset($_POST['ubah_file'])){ 
                ...
                if(move_uploaded_file($tmp, $path)){ 
                  ...
                  ?><script>alert("data atau file telah diubah");window.location.href="surat_masuk.php";</script><?php 
                ...
                ?><script>alert("data telah diubah");window.location.href="surat_masuk.php";</script><?php
              }
            }
              ?>
